...
<?php 
    ...
    $contlinhas = $pdo->query("SELECT * FROM unimeds WHERE CNPJ = '$cnpj'");
    ...
    <head>
        ...
        <body>
            ...
            <div style="border: 0px solid red; width: 700px; height: 900px;">
                ...
                <center><img width=500 height=75 src="http://localhost/cartaquitacaoNOVO/resources/images/timbradoTopo.jpg">
              ...
              ';
                ...
                $html .= "<center><img src='http://localhost/cartaquitacaoNOVO/resources/images/assinatura.jpg'> ";
                $html .= '<br>';
                $html .= 'Três Corações, ' . $data;
                $html .= '<br>';
                $html .= '<br>';
                ...
                $html .= '<img src=<img width=700  src="http://localhost/cartaquitacaoNOVO/resources/images/timbradoBase.jpg"></center>';
